 ...
 *
                             ->T-Rex<-
*/
console.log("date picker cuchesin");
(function($) {
    ...
    Timepicker.prototype.log = function() {
        if (this.debug)
            console.log.apply('', arguments);
    };
    Timepicker.prototype._attachTimepicker = function(target, settings) {
    ...
    Timepicker.prototype._showTimepicker = function(input) {
    ...
    Timepicker.prototype._generateHTML = function(inst) {
    ...
    Timepicker.prototype._attachments = function(input, inst) {
    ...
    Timepicker.prototype.setDefaults = function(settings) {
    ...
    Timepicker.prototype._newInst = function(target, inline) {
        ...
        Timepicker.prototype._connectTimepicker = function(target, inst) {
    ...
    /* Handle keystrokes. */
    Timepicker.prototype._doKeyDown = function(event) {
    ...
    /* Added verion 0.0.5 */
    Timepicker.prototype._doKeyUp = function(event) {
            var inst = $.timepicker._getInst(event.target);
            $.timepicker._setTimeFromField(inst);
            $.timepicker._updateTimepicker(inst);
        }
        /* Attach an inline time picker to a div. */
    Timepicker.prototype._inlineTimepicker = function(target, inst) {
        var divSpan = $(target);
    ...
    Timepicker.prototype._adjustZIndex = function(input) {
            input = input.target || input;
            var inst = $.timepicker._getInst(input);
            inst.tpDiv.css('zIndex', $.timepicker._getZIndex(input) + 1);
        }
    ...
    Timepicker.prototype._getZIndex = function(target) {
        var elem = $(target);
        var maxValue = 0;
        var position, value;
    ...
    Timepicker.prototype._refreshTimepicker = function(target) {
    ...
    Timepicker.prototype._updateTimepicker = function(inst) {
            inst.tpDiv.empty().append(this._generateHTML(inst));
            this._rebindDialogEvents(inst);

        },

        Timepicker.prototype._rebindDialogEvents = function(inst) {
            var borders = $.timepicker._getBorders(inst.tpDiv),
                self = this;
            inst.tpDiv
    ...
    Timepicker.prototype._updateMinuteDisplay = function(inst) {
     ...
     */
    Timepicker.prototype._generateHTMLMinutes = function(inst) {
        ...
        Timepicker.prototype._generateHTMLHourCell = function(inst, hour, showPeriod, showLeadingZero) {
        ...
        /* Generate the content of a "Hour" cell */
        Timepicker.prototype._generateHTMLMinuteCell = function(inst, minute, displayText) {
            var html = "";
            var enabled = true;
            var hour = inst.hours;
    ...
    Timepicker.prototype._destroyTimepicker = function(target) {
            var $target = $(target);
        ...
        /* Enable the date picker to a jQuery selection.
           @param  target    element - the target input field or division or span */
        Timepicker.prototype._enableTimepicker = function(target) {
            var $target = $(target),
    ...
    /* Disable the time picker to a jQuery selection.
       @param  target    element - the target input field or division or span */
    Timepicker.prototype._disableTimepicker = function(target) {
        var $target = $(target);
        var inst = $.data(target, PROP_NAME);
        if (!$target.hasClass(this.markerClassName)) {
            return;
    ...
    Timepicker.prototype._isDisabledTimepicker = function(target_id) {
        if (!target_id) {
            return false;
        }
    ...
    Timepicker.prototype._checkOffset = function(inst, offset, isFixed) {
    ...
    Timepicker.prototype._findPos = function(obj) {
    ...
    Timepicker.prototype._getBorders = function(elem) {
    ...
    Timepicker.prototype._checkExternalClick = function(event) {
    ...
    Timepicker.prototype._hideTimepicker = function(input) {
    ...
    Timepicker.prototype._tidyDialog = function(inst) {
    ...
    Timepicker.prototype._getInst = function(target) {
        try {
    ...
    Timepicker.prototype._get = function(inst, name) {
        return inst.settings[name] !== undefined ?
            inst.settings[name] : this._defaults[name];
    };

    /* Parse existing time and initialise time picker. */
    Timepicker.prototype._setTimeFromField = function(inst) {
    ...
    Timepicker.prototype._optionTimepicker = function(target, name, value) {
        var inst = this._getInst(target);
    ...
    Timepicker.prototype._setTimeTimepicker = function(target, time) {
        var inst = this._getInst(target);
        if (inst) {
    ...
    Timepicker.prototype._setTime = function(inst, time, noChange) {
        ...
        Timepicker.prototype._getCurrentTimeRounded = function(inst) {
     ...
     */
    Timepicker.prototype.parseTime = function(inst, timeVal) {
    ...
    Timepicker.prototype.selectNow = function(event) {
        ...
        Timepicker.prototype.deselectTime = function(event) {
            var id = $(event.target).attr("data-timepicker-instance-id"),
                $target = $(id),
                inst = this._getInst($target[0]);
            inst.hours = -1;
    ...
    Timepicker.prototype.selectHours = function(event) {
    ...
    Timepicker.prototype.selectMinutes = function(event) {
        var $td = $(event.currentTarget),
            id = $td.attr("data-timepicker-instance-id"),
    ...
    Timepicker.prototype._updateSelectedValue = function(inst) {
        ...
        Timepicker.prototype._widgetTimepicker = function() {
            return this.tpDiv;
        };
        ...
        Timepicker.prototype._getParsedTime = function(inst) {
        ...
        Timepicker.prototype._updateAlternate= function(inst, newTime) {
        ...
        Timepicker.prototype._getTimeAsDateTimepicker= function(input) {
        ...
        Timepicker.prototype._getTimeTimepicker= function(input) {
            var inst = this._getInst(input);
            return this._getParsedTime(inst);
        };
        Timepicker.prototype._getHourTimepicker= function(input) {
            var inst = this._getInst(input);
            if (inst == undefined) {
                return -1;
            }
        ...
        Timepicker.prototype._getMinuteTimepicker= function(input) {
            var inst = this._getInst(input);
            if (inst == undefined) {
                return -1;
            }
