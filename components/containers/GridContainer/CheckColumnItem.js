...
*/
Components.CheckColumn.prototype.init = function(dataObj) {
    this.config = {
        container: $('body'),
		container1: '',	
        parentName: "",
    ...
    this.className = "checkColumnItem";
    this.editable = false;
    
    this.listeners = this.config.listeners;
}
//##############################################################################
Components.CheckColumn.prototype.create = function() {
...
//##############################################################################
Components.CheckColumn.prototype.setControls = function() {
...
//##############################################################################
Components.CheckColumn.prototype.show = function() {
...
//##############################################################################
Components.CheckColumn.prototype.hide = function() {
    this.divContainer.hide();
    $('.' + this.id, this.config.container.parent()).hide();
}
Components.CheckColumn.prototype.showEditor = function(container) {
    
    return null;
}
//##############################################################################
Components.CheckColumn.prototype.destroyEditor = function() {
    this.editor.destroy();
}
//##############################################################################
Components.CheckColumn.prototype.drawData = function(row, contentField) {
