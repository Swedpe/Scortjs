//fila externa, no tengo el nombre del desarrollador original
//Se usa como parte de Scort JS desde 2015
...
function initializeDraggableElements() 
{
    ...
    var allChildren = Root.getElementsByTagNameNS(SVGNS, "*");
    for(var child = 0; child < allChildren.length; ++child) {
        ...
        var bFoundDraggable = (ele.getAttributeNS(null, "drag:enable") == "true");
