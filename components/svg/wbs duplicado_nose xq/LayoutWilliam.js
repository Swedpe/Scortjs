...
//---------------------------------------------------------------------------------------------------------------------------------------------------------
LayoutWilliam.prototype.calculaNodoW  = function(NodoId,PadreObj) {
	...
	if($this.screenGrid.MaxLevel<$this.Level)	
		...
		for (var indice in $this.childsId){
			if(typeof(items[$this.childsId[indice]]) !='undefined'){                           
							...
							$this.childs[$this.childsId[indice]].tree.LayoutAlgoritm.calculaNodoW($this.childs[$this.childsId[indice]].id,$this);			
			}
		} 
