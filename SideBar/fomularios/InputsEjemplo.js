function InputsFinales(){
Components.create('FreeDiv',{
id:'mainContent',
freeHtml:true,
container: $('.page-content'),
html:'<strong><FONT FACE="arial"> <p style="color: #BD133D; font-size: 14pt">INPUT FIELD SCORT</P></font></strong> <div class="row"><div  id="ejemplo1" class="col-sm-4" style="height: 300px" ><strong><FONT FACE="arial"> <p style="color: #BD133D; font-size: 12pt"> Inputs con diferentes estados</P></font></strong> <br><br></div><div id="ejemplo2" class="col-sm-4" style="height: 300px"><strong><FONT FACE="arial"> <p style="color: #BD133D; font-size: 12pt"> Inputs con diferentes estados + iconos</P></font></strong> </div><div id="ejemplo4" class="col-sm-4" style="height: 300px"><strong><FONT FACE="arial"> <p style="color: #BD133D; font-size: 12pt">Inputs con diferentes estados + labels</P></font></strong> </div></div><!--El ancho es de 12 columnas, una vez ocupadas las 12 se cierra el row-->	<div class="row"><div id="ejemplo6" class="col-sm-4" style =" height: 300px ;"><strong><FONT FACE="arial"> <p align="left" style="color: #BD133D; font-size: 12pt">Inputs Addons - Icons </P></font></strong> </div><div id="ejemplo7" class="col-sm-8" style =" height: 300px ;" align="right">  <strong><FONT FACE="arial"> <p align="center" style="color: #BD133D; font-size: 12pt"> Inputs Addons - Button </P></font></strong> </div></div>',
});
